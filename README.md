...
I got the code for the black hole javascript animation from a [codepen](https://codepen.io/Aditya-bhoyar/pen/eYXJzve). The original had purple color which is fascinating itself but I prefer the orange-yellow hue. Moreover, the original source could be [here](https://github.com/brunosimon/webgl-black-hole/) as found in a [tweet](https://xcancel.com/bruno_simon/status/1544707908683833346).